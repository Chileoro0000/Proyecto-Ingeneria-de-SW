...
def GestoReconocido(emotion):
	...
	if emotion == 'InflarMejillas': 
		webbrowser.open("http://www.google.cl", new=2, autoraise=True)
		time.sleep(10)
...
dataPath = 'C:/Users/gabil/Desktop/PROYECTO VISION ARTIFICIAL/DATA' #Cambia a la ruta donde hayas almacenado Data
...
while True:
	...
	for (x,y,w,h) in faces:
		...
		if method == 'LBPH':
			if result[1] > 60 and result[1] < 65:
